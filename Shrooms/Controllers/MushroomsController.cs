...
namespace Shrooms.Controllers
{
  ...
  public class MushroomsController : ControllerBase
  {
    ...
    // GET api/Mushrooms
    [HttpGet]
    public ActionResult<IEnumerable<Mushroom>> Get(string name, string family, bool psycho, bool poisonous, string region, string sporePrintDetails, string visualDetails, int capDimensions, int stemDimensions)
    {
